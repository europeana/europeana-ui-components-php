<?php
	...
	$m = new Mustache_Engine(
		array(
			'loader' => new Mustache_Loader_FilesystemLoader( realpath( APPLICATION_PATH ) . '/vendor/europeana/ui-components' ),
			'partials_loader' => new Mustache_Loader_FilesystemLoader( realpath( APPLICATION_PATH ) . '/vendor/europeana/ui-components' )
		)
	);
